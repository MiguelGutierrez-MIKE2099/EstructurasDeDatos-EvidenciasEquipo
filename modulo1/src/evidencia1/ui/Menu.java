...
/**
 * Menu proporciona un conjunto de variables y miembros
 * que describen una plantilla de un menú de usuario.
 */
public class Menu {
    /**
    ...
    private String REQUEST_OPTION = "Ingrese el número que corresponde a la opción elegida: ";
    private String NUMERIC_TYPE_ERROR = "El valor ingresado no tiene un formato numérico. Intente de nuevo: ";
    private String OUT_OF_RANGE_ERROR = "Opción no disponible. Intente de nuevo: ";
    private String END_OF_PROGRAM = "Fin del Programa.";
    /**
    ...
    /**
     * alive establece el estado de disponibilidad del menú para
     * el usuario y ayuda a determinar si el menú debe mantenerse mostrado o no.
     */
    private boolean alive = true;
    /**
     * killMenu establece que el menú del usuario
     * debe dejar de mostrarse al usuario.
     */
    ...
    /**
     * isAlive determina el estado de
     * disponibilidad del menú para el usuario.
     */
    ...
    public Menu addOption(String option, MenuAccion MenuAccion) {
        ...
        MenuAccionLista.add(MenuAccion);
        return this;
    }
